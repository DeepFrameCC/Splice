...
const MEDIAS: MediaSeed[] = [
  ...
  },
  {
    ...
    filename: "pc-gamer.webp",
    folder: "pixel404",
    title: "PC Gamer — Pixel 404",
    description: "Photo produit PC gamer pour les reseaux sociaux de Pixel 404, magasin gaming a Orleans.",
    category: "pub-sociaux",
    owner: Founder.LOUISIA,
    prixEstime: 200,
    materiel: ["Sony ZV1"],
    client: "Pixel 404",
    groupKey: "pixel404-pc-gamer",
    groupOrder: 0,
  },
  {
    type: MediaType.VIDEO,
    filename: "edit-ppc.mp4",
    folder: "pixel404",
    thumbnailUrlRaw: `${CDN}/pixel404/pc-gamer.webp`,
    title: "Edit PPC — Pixel 404",
    description: "Pub sociale video pour Pixel 404 — format reseaux sociaux.",
    category: "pub-sociaux",
    owner: Founder.LOUISIA,
    prixEstime: 300,
    materiel: ["Sony ZV1", "DaVinci Resolve"],
  ...
  // ── Serie Westfield FW300 — groupee en un seul projet (carrousel 4 photos) ─
  {
    type: MediaType.PHOTO,
    filename: "westfield-fw300-4.webp",
    folder: "photos",
    title: "Westfield FW300",
    description: "Westfield FW300 — roadster ultra-leger 192 ch, 640 kg. Shooting exterior.",
    category: "automobile",
    owner: Founder.LOUISIA,
    prixEstime: 400,
    materiel: ["Sony ZV1"],
    groupKey: "westfield-fw300",
    groupOrder: 0,
  },
  {
    type: MediaType.PHOTO,
    filename: "westfield-fw300-1.webp",
    folder: "photos",
    title: "Westfield FW300 — phare & carbone",
    description: "Detail phare rond et aile en fibre de carbone — Westfield FW300.",
    category: "automobile",
    owner: Founder.LOUISIA,
    prixEstime: 250,
    materiel: ["Sony ZV1"],
  ...
  {
    type: MediaType.PHOTO,
    filename: "westfield-fw300-2.webp",
    folder: "photos",
    title: "Westfield FW300 — echappement",
    description: "Echappement inox poli — Westfield FW300.",
    category: "automobile",
    owner: Founder.LOUISIA,
    prixEstime: 250,
    materiel: ["Sony ZV1"],
  ...
  {
    type: MediaType.PHOTO,
    filename: "westfield-fw300-3.webp",
    folder: "photos",
    title: "Westfield FW300 — jante",
    description: "Jante alliage Westfield — detail centre de roue.",
    category: "automobile",
    owner: Founder.LOUISIA,
    prixEstime: 250,
    materiel: ["Sony ZV1"],
