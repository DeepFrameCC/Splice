# Splice Studio — Direction artistique 03 · Cinéma Studio

> Brief à transmettre à un développeur / Claude Code pour implémenter la direction
> visuelle "Cinéma Studio" sur le site **Splice Studio** (studio image & son) et sur
...
- **Haut gauche** : `Splice Studio` (mono, ls 0.22em, glauque)
...
*Fin du brief — Direction 03 · Cinéma Studio · Splice Studio · 2026*
