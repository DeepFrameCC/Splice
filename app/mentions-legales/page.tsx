...
export const metadata: Metadata = {
  ...
  description: "Mentions légales du site DeepFrame — production audiovisuelle à Orléans et Tours.",
};
        ...
        <section className="mt-10 space-y-8 text-sm leading-relaxed text-white/80">
          ...
          <div>
            ...
            <p>
              ...
              que soit le moyen ou le procédé utilisé, est interdite sauf autorisation écrite préalable de DeepFrame.
            </p>
            <p className="mt-2">
          ...
          <div>
            ...
            <p className="mt-2">
              Le site peut contenir des liens hypertextes vers d&apos;autres sites. DeepFrame ne dispose d&apos;aucun
