  ...
  return (
    <>
      ...
      <section className="mx-auto flex min-h-[70vh] max-w-xl flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <p className="mt-4 text-lg leading-relaxed text-df-ink/70">
        ...
        <p className="mt-2 text-base text-df-ink/60">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link
            href="/register"
            className="rounded-full bg-df-gold px-6 py-3 text-sm font-bold text-df-ink transition hover:scale-105 hover:shadow-lg"
          >
