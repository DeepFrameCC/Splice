      ...
      <div className="overflow-hidden rounded-xl border border-white/[0.08] bg-df-surface">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="flex items-center gap-4 border-b border-white/[0.06] px-4 py-4">
            <div className="h-5 flex-1 rounded bg-df-blue/10" />
            <div className="h-5 w-16 rounded-full bg-df-blue/10" />
            <div className="h-5 w-24 rounded bg-df-blue/10" />
          </div>
        ))}
      </div>
    </div>
